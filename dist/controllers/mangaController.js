...
exports.getMangaByTitle = exports.getAllMangas = void 0;
const manga_1 = __importDefault(require("../models/manga"));
const getAllMangas = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        const allManga = yield manga_1.default.find({});
